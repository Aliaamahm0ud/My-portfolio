                    ...
                    <div className="container-fluid">
                        ...
                        <div className="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul className="navbar-nav ms-auto mb-2 mb-lg-0 align-items-lg-center">
                                ...
                                <li className="nav-item">
                                    <a onClick={() => activeLink("about")} className={`${activeClass("about")}nav-link`} aria-current="page" href="#about">About</a>
                                </li>
                                <li className="nav-item">
                                    <a onClick={() => activeLink("skills")} className={`${activeClass("skills")}nav-link`} href="#skills">Skills</a>
                                </li>
                                <li className="nav-item">
                                    <a onClick={() => activeLink("services")} className={`${activeClass("services")}nav-link`} href="#services">Services</a>
                                </li>
                                <li className="nav-item">
